    ...
    <div className="container" data-aos="fade-up">
      ...
      <div className="privacy-header" data-aos="fade-up">
        <div className="header-content">
          ...
          <p className="intro-text">This Privacy Policy describes how we collect, use, process, and disclose your information, including personal information, in conjunction with your access to and use of our services.</p>
        </div>
      </div>
      {/* Main Content */}
