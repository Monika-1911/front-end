                            ...
                            <div className="p-3 p-md-4 p-xl-5">
                                ...
                                <form onSubmit={submited}>
                                    <div className="row gy-3 gy-md-4 overflow-hidden">
                                        <div className="col-12">
                                            ...
                                            <input type="text" value={newdata.name} onChange={getchange} className="form-control" name="name" id="firstName" placeholder="First Name" required />
                                        </div>

                                        <div className="col-12">
                                            <label htmlFor="email" className="form-label">Email <span className="text-danger">*</span></label>
                                            <input type="email" value={newdata.email} onChange={getchange} className="form-control" name="email" id="email" placeholder="name@example.com" required />
                                        </div>
                                        <div className="col-12">
                                            <label htmlFor="password" className="form-label">Password <span className="text-danger">*</span></label>
                                            <input type="password" value={newdata.password} onChange={getchange} className="form-control" name="password" id="password" placeholder='your password' required />
                                        </div>
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        ...
                                        <p className="m-0 text-secondary text-end">Already have an account? <a href="#!" className="link-primary text-decoration-none">Sign in</a></p>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-12">
